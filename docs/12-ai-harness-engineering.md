...
## 12.5 정량 지표 (2026-04-23 기준)

### 12.5.1 에이전트 사용량 (총 34 인스턴스 / 4 미션)
...
## 12.10 남은 작업 (D6 ~ D7 + 본 문서 갱신 계획)

- [ ] D5 구현 완료 (현재 진행 중)
- [ ] D6 — 관측 가능성 보강 + 부하 테스트 시나리오
- [ ] D7 — k6 부하 테스트 + Grafana 스크린샷 + 최종 문서화
- [ ] **본 문서 12.5/12.6/12.9 절 최종 수치로 갱신** (제출 직전)
